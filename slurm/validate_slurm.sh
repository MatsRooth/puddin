...
#SBATCH -o %x_%jslurm.out              # Name of stdout output log file (%j expands to jobID)
#SBATCH -e %x_%jslurm.err              # Name of stderr output log file (%j expands to jobID)
...
(time python /share/compling/projects/puddin/script/confirm_doc_ids.py -d ${DATA_DIR} ) 2>&1
#-g 'test' -g 'val' # >${SLURM_JOB_NAME}_${SLURM_JOB_ID}python.out 2>${SLURM_JOB_NAME}_${SLURM_JOB_ID}python.err
