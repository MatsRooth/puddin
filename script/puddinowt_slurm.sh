...
#SBATCH --mem=20G                    # Total amount of (real) memory requested (per node)
...
echo "***********************************************"
echo "python /home/arh234/projects/puddin/script/parse_pile.py -i ${IN_FILE} -d ${DATA_DIR} -c OpenWebText2 > >(tee -i -a ${LOG_FILE}) 2>&1"
echo ">>>>>>>>>>"

python /home/arh234/projects/puddin/script/parse_pile.py -i ${IN_FILE} -d ${DATA_DIR} -c OpenWebText2 > >(tee -i -a ${LOG_FILE}) 2>&1